// This suite starts a real PostgreSQL container through testcontainers, so it only runs
// when Docker is available: go test -tags docker ./tests/integration/
// The SQLite suite in this package runs against an in-memory database and needs no tag.
...
import (
	...
	postgresrepo "github.com/yeferson59/go-better-auth/internal/infra/db/postgres"
)
